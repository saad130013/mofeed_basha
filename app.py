...
# Streamlit app - نسخة محدثة باستخدام نموذج محلي (llama-cpp-python)
...
st.markdown("""
مرحبا بك! ارفع ملف **PDF** أو **Excel** وسأقوم بتحليل المحتوى، الإجابة على أسئلتك، وتوليد تقرير لك باستخدام نموذج ذكاء صناعي يعمل محليًا.
""")
...
if uploaded_file:
    ...
    if question and text:
        with st.spinner("🤔 مفيد باشا يفكر..."):
            llm = LlamaCpp(
                model_path="./ggml-model-q4_0.bin",  # تأكد من وجود النموذج في نفس المجلد
                temperature=0.1,
                max_tokens=512,
                top_p=0.95,
                n_ctx=2048,
